window.addEventListener("DOMContentLoaded", function(){
    ...
    btn.onclick=function(){
        ...
        for(let art of articole){
            ...
            var conditie2=parseInt(document.getElementById("inp-pret").value) > parseInt(pret.innerHTML);
            ...
            var conditie3=false;
            switch (valCalorii){
                case "1": conditie3= (caloriiArt<200); break;
                case "2": conditie3= (caloriiArt>=201 && caloriiArt<300); break;
                case "3": conditie3= (caloriiArt>=350); break;
            ...
            var checkboxes=document.getElementsByName("ingrediente_check");
    
            for (let chk of checkboxes){
                if (chk.checked){
                    var valingrediente=rad.value;//poate fi 1, 2 sau 3
                    break;
                }
            }
            // for (let chk of checkboxes){
    ...
    //         var ingredArt= parseInt(art.getElementsByClassName("val-ingrediente").innerHTML);
    //          conditie5=false;
    //         switch (valingrediente){
    //             case "1": conditie5= (ingredArt="orez"); break;
    //             case "2": conditie5= (ingredArt="alge marine"); break;
    //             case "3": conditie5= (ingredArt="somon"); break;
    //             case "4": break;
