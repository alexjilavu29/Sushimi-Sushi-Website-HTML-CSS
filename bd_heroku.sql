...
CREATE TYPE categ_sushi AS ENUM( 'comanda speciala', 'traditional', 'editie limitata', 'vegetarian', 'comun');
...
('Nimic', 'Nimic', 1 , 0, 0, 'restaurant', 'vegetarian', '{}', True, 'nimic.jpg'),
...
('Saba', 'Calitatea înaltă a macroului, pe un pat de orez aromat', 30 , 2, 350, 'sushi bar', 'editie limitata', '{"macrou marinat","orez","otet"}', False, 'saba.jpeg'),
...
('Oshinko Maki', 'Ai vrea să ai parte de delciile asiatice dar esti vegetarian sau pur și simplu nu-ți place peștele? Încearcă această rețetă specială cu ridiche murată Daikon', 25 , 6, 150, 'restaurant', 'vegetarian', '{"ridiche Daikon","orez","alge marine","castravete","avocado"}', True, 'Oshinko_Maki.jpg'),
